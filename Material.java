...
public class Material {
    ...
    public final static Material Rock = new Material(0.1f, 0.6f, 0.4f, 0.8f);
    public final static Material Wood = new Material(0.2f, 0.3f, 0.5f, 1f);
    public final static Material Metal = new Material(0.05f, 1.2f, 0.25f, 0.5f);
    public final static Material Bouncy = new Material(0.8f, 0.3f, 0.9f, 0.7f);
